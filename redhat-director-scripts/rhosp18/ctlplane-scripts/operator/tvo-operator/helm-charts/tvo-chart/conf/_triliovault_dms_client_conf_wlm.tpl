...
# Database connection
db_url = mysql+pymysql://{{ .Values.database.wlm.user }}:{{ .Values.database.wlm.password }}@{{ .Values.database.common.host }}:{{ .Values.database.common.port }}/{{ .Values.database.wlm.database }}
