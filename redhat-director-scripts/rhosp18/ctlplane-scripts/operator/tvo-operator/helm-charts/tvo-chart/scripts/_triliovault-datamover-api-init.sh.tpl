...
touch /tmp/pod-shared-triliovault-datamover-api/triliovault-dms-client-dynamic.conf
...
tee > /tmp/pod-shared-triliovault-datamover-api/triliovault-dms-client-dynamic.conf << EOF
[client]
