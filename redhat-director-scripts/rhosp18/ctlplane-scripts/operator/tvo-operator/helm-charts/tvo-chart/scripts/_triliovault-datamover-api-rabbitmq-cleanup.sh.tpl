...
# dmapi vhost here always already exists from whatever version was previously installed
# (there is nothing to clean on a fresh install, hence pre-upgrade only, not pre-install).
#
...
# at once leak large numbers of orphaned per-consumer queues (TVAULT-7519). Deleting the
