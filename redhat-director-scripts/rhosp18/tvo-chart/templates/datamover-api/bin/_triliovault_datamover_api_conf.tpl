...
[database]
connection = "mysql+pymysql://{{- .Values.database.datamover_api.user -}}:{{- .Values.database.datamover_api.password -}}@{{- .Values.database.common.host -}}/{{- .Values.database.datamover_api.database -}}"
