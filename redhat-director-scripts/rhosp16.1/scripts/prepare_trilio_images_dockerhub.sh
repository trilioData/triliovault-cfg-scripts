...
<<<<<<< HEAD:redhat-director-scripts/podman_prepare_images_dockerhub.sh
...
>>>>>>> upstream/4.1OSI:redhat-director-scripts/rhosp16.1/scripts/prepare_trilio_images_dockerhub.sh
