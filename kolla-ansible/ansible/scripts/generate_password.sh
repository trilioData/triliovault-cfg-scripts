...
NEUTRON_SERVICE_KS_PASSWORD=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w ${11:-42} | head -n 1`
...
triliovault_neutron_service_keystone_password: $NEUTRON_SERVICE_KS_PASSWORD
EOF
